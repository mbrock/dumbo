defmodule DumboWeb.NodeLiveTest do
  use DumboWeb.ConnCase

  import Phoenix.LiveViewTest
  import Dumbo.MeshFixtures

  @create_attrs %{definition: %{}, friendly_name: "some friendly_name", ieee_address: "some ieee_address"}
  ...
  describe "Index" do
    ...
    test "lists all nodes", %{conn: conn, node: node} do
      ...
      assert html =~ node.friendly_name
    end
    ...
    test "saves new node", %{conn: conn} do
      ...
      assert html =~ "some friendly_name"
    end
    ...
    test "updates node in listing", %{conn: conn, node: node} do
      ...
      assert html =~ "some updated friendly_name"
    end
